          ...
          <div className="p-8">
            <form onSubmit={handleLogin} className="space-y-6">
              ...
              <button
                ...
                className="w-full border-2 border-dashed border-gray-300 text-gray-600 font-medium py-3 rounded-lg hover:bg-gray-50 transition-colors flex items-center justify-center"
              >
                <svg
                ...
                Use Demo Credentials (For Judges)
              </button>
