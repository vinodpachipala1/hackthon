...
const ComplaintDetailPage = () => {
  ...
  const mockComplaint = {
    ...
    complaint_type: "Lost / Non-delivery",
    complaint_text: "My speed post containing important legal documents has not been delivered even after 10 days of expected delivery date. The tracking shows it reached the local post office 8 days ago but no updates since then. These are time-sensitive documents and I'm facing serious consequences due to this delay. Please investigate urgently.",
    ...
    // AI generated fields
    ai_category: "Lost Article",
    department: "Speed Post Department",
    sentiment_score: -0.85,
    priority_level: "CRITICAL",
    auto_response: "We sincerely regret the inconvenience caused by the delay in delivery of your important documents. Our records show that the package arrived at the Hyderabad GPO on Jan 10. We have escalated this to our local delivery supervisor for immediate investigation. You will receive an update within 24 hours. For urgent matters, you may visit the Hyderabad GPO with this complaint ID.",
    priority_reasons: [
      "Contains keyword: 'important legal documents'",
      "Sentiment score indicates high frustration",
      "Tracking shows delivery delay > 7 days",
      "Financial/legal implications mentioned"
    ],
    
    status: "ACTIVE",
    created_at: "2025-01-15 10:30",
    verified_at: "2025-01-15 10:32"
  };
  ...
  useEffect(() => {
    const fetchComplaint = () => {
      ...
      setTimeout(() => {
        ...
        setFinalResponse(mockComplaint.auto_response);
        setLoading(false);
      }, 800);
    };
  ...
  const submitResponse = () => {
    ...
    // Mock API call
    setTimeout(() => {
      setSuccess("✅ Response approved and sent to complainant. Complaint marked as RESOLVED.");
  ...
  const submitAiFeedback = (helpful) => {
    ...
    // Mock API call
    setTimeout(() => {
      setSuccess(prev => prev + ` AI feedback recorded: ${helpful ? 'Helpful' : 'Not helpful'}.`);
  ...
  const updateComplaintStatus = (newStatus) => {
    ...
    // Mock API call
    console.log(`Updated complaint ${id} status to ${newStatus}`);
            ...
            <div className="flex items-center">
              ...
              <div>
                ...
                <p className="text-sm text-gray-600">
                  Officer: <span className="font-medium">{localStorage.getItem("officer_email") || "Officer"}</span>
                </p>
              </div>
            </div>
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        <div className="bg-white rounded-xl shadow-lg border border-gray-200 p-6 mb-6">
          <div className="flex flex-col md:flex-row md:items-center justify-between mb-6">
            <div>
              <div className="flex items-center mb-2">
                ...
                <span className={`inline-flex items-center px-3 py-1 rounded-full text-sm font-medium ${getPriorityColor(complaint.priority_level)}`}>
            ...
            <div className="mt-4 md:mt-0">
              <div className={`inline-flex items-center px-4 py-2 rounded-lg text-sm font-medium ${getStatusColor(complaint.status)}`}>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-8">
            <div className="bg-gray-50 p-4 rounded-lg border border-gray-200">
              <h3 className="font-medium text-gray-700 mb-2">Complainant Details</h3>
              <div className="space-y-2">
                ...
                <div className="flex justify-between">
                  ...
                  <span className="font-medium">{complaint.city}, {complaint.pincode}</span>
                </div>
                <div className="flex justify-between">
            ...
            <div className="bg-gray-50 p-4 rounded-lg border border-gray-200">
              ...
              <div className="space-y-2">
                ...
                <div className="flex justify-between">
                  ...
                  <span className="font-mono font-medium">{complaint.tracking_number || "Not provided"}</span>
                </div>
                <div className="flex justify-between">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
            ...
            <div className="bg-white rounded-xl shadow-lg border border-gray-200 p-6">
              ...
              <div className="space-y-4">
                <div className="flex items-center justify-between">
                  ...
                  <div className="flex items-center">
                    <span className={`font-bold mr-2 ${getSentimentColor(complaint.sentiment_score)}`}>
                      {complaint.sentiment_score?.toFixed(2)}
                    </span>
                    <div className="w-24 h-2 bg-gray-200 rounded-full overflow-hidden">
                      <div 
                        className={`h-full ${getSentimentColor(complaint.sentiment_score).replace('text-', 'bg-')}`}
                        style={{ width: `${Math.abs(complaint.sentiment_score) * 100}%` }}
                      ></div>
                    </div>
                  </div>
                </div>
                ...
                <div>
                  <span className="text-gray-700 mb-2 block">Priority Reasons:</span>
          ...
          <div className="space-y-6">
            ...
            {/* Officer Response */}
            <div className="bg-white rounded-xl shadow-lg border border-gray-200 p-6">
              <h3 className="text-xl font-bold text-gray-900 mb-4">Final Response</h3>
            ...
            {showAiFeedback && (
              <div className="bg-white rounded-xl shadow-lg border border-gray-200 p-6">
                ...
                <p className="text-gray-600 mb-4">
                  Was the AI-suggested response helpful for resolving this complaint?
                </p>
